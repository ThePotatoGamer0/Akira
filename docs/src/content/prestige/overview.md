...
- Exactly five milestone claims before prestige unlocks the standard prestige frame.
- Seven or more claims swap in a **veteran** frame variant.
- Ten or more give a **unique** prestige frame line.
...
Prestige loops: thresholds grow harder, but Akira keeps the climb rewarding.

## See also

- [Personal milestones](/economy/personal-milestone)
- [Bits](/economy/bits)
- [Server buff pool](/economy/server-pool)
